...
Needing to Hide is a recurring scene. Needing to Hide begins when must_hide is 9990.
...
Before going east:
	...
	continue the action.
Before going north:
	if a random chance of 1 in 4 succeeds and player is not in Jeep and the player is not in the Office:
		now must_hide is 1;
	continue the action.
Before going south:
	if a random chance of 1 in 4 succeeds and player is not in Jeep:
